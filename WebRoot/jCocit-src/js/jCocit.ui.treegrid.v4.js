(function($, jCocit) {
	...
	;
	function loadData(_40, _41, _42, _43) {
	...
	function _90(_91, _92) {
		...
		loadData(_91, _92.parent, _92.data, true);
	}
	;
	...
	function _a2(_a3, _a4) {
		...
		_2f(_a3);
		_a5.total -= 1;
		$(_a3).datagrid("getPager").pagination("refresh", {
			total : _a5.total
		});
		$(_a3).treegrid("showLines");
	}
	;
	function showLines(_a7) {
		var t = $(_a7);
	...
	$.fn.treegrid.parseOptions = function(_ca) {
		return $.extend({}, $.fn.datagrid.parseOptions(_ca), jCocit.parseOptions(_ca, [ "treeField", {
			animate : "boolean"
		} ]));
	};
	...
	$.fn.treegrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
		...
		loader : function(data, onLoadSuccess, onLoadError) {
