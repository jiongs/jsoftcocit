 ...
 * @param <T>
 */
public interface SystemMenuService extends NamedEntityService<ISystemMenu>, ISystemMenu, AuthorizedObject {

	CocEntityService getCocEntity();

	SystemService getSystem();

	Class getClassOfEntity();

	List<String> getActionKeysWithoutRow();
	...
	List<CocActionService> getCocActions();

	List<CocActionService> getCocActions(List<String> actionKeys);
