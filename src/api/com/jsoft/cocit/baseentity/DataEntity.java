 ...
 * <LI>createdUser：创建帐号，数据库端默认字段名【created_user_】，字段类型【逻辑外键，关联到“用户信息表的逻辑主键{@link IUserEntity#getCode()}”】，字段长度【64】
 * <LI>createdLogin：创建者登录信息，数据库端默认字段名【created_login_】，字段类型【逻辑外键，关联到“登录日志表的逻辑主键{@link ILogLoginEntity#getCode()}”】，字段长度【64】
 * <LI>updatedDate：最近修改时间，数据库端默认字段名【updated_date_】，字段类型【Date】
 * <LI>updatedUser：最近修改帐号，数据库端默认字段名【updated_user_】，字段类型【逻辑外键，关联到“用户信息表的逻辑主键{@link IUserEntity#getCode()}”】，字段长度【64】
 * <LI>updatedLogin：最近修改者登录信息，数据库端默认字段名【updated_login_】，字段类型【逻辑外键，关联到“登录日志表的逻辑主键{@link ILogLoginEntity#getCode()}”】，字段长度【64】
 ...
 * @preserve all
 */
public abstract class DataEntity implements IDataEntityExt {
	...
	public String toJsonString() {
		...
		sb.append("\"key\": ").append(JsonUtil.toJson(code));
		toJson(sb);
