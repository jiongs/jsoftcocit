 ...
 */
public interface ISystemMenuEntity extends ITreeEntity {
	/**
	 * 系统KEY：用来描述该菜单属于哪个系统？
	 * <UL>
	 * <LI>开发平台中可以有多个“逻辑系统”，该方法用来获取该菜单所属的系统。
	 * <LI>逻辑外键，关联到“系统（{@link ISystemEntity}）”的“逻辑主键（{@link ISystemEntity#getCode()}）”。
	 * </UL>
	 */
	 ...
	 * <UL>
	 * <LI>逻辑外键，关联到“数据源实体（{@link IDataSourceEntity}）”的“逻辑主键（{@link IDataSourceEntity#getCode()}）”。
	 * </UL>
	 */
	 ...
	 * 注：同一个“实体”可以同时挂载到不同的菜单上。
	 * <p>
	 * 其值关联到{@link CocAction#code()}，多个操作之间用竖线‘|’分隔。
	 * <p>
	 * 如：c|e|v|d
	 * <p>
	 * 相当于“操作权限”的一种实现方式
	 ...
	 * 界面KEY：
	 * <UL>
	 * <LI>实体菜单：如果菜单类型为“实体菜单”，即用来描述该“实体菜单”引用“实体定义”中的哪个界面？其值关联到{@link CuiEntity#code()}。
	 * </UL>
	 * 
	 */
