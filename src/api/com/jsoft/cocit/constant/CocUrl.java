 ...
 * 
 */
public interface CocUrl {

	public static final String PATH_PARAM_EMPTY = "~";
	...
	public static final String WORKFLOW_URL_PREFIX = "/cocworkflow";
	public static final String ENTITY_URL_PREFIX = "/cocentity";
	public static final String COMBO_URL_PREFIX = "/coccombo";
	...
	public static final String COMBO_GET_GRID_DATA = COMBO_URL_PREFIX + "/getGridData/*";
	/**
	...
	public static final String COMBO_GET_COMBOGRID_DATA = COMBO_URL_PREFIX + "/getComboGridData/*";
	/**
	 * 获取Combo List数据。
	 * <p>
	...
	public static final String COMBO_GET_COMBOTREE_DATA = COMBO_URL_PREFIX + "/getComboTreeData/*";
	...
	public static final String COMBO_GET_TREE_DATA = COMBO_URL_PREFIX + "/getTreeData/*";
	...
	public static final String COMBO_GET_FILTER_DATA = COMBO_URL_PREFIX + "/getFilterData/*";
	...
	public static final String COMBO_GET_FORM_TO_SAVE = COMBO_URL_PREFIX + "/getFormToSave/*";
