package com.jsoft.cocimpl.mvc.servlet;
...
public class StaticResourceFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		...
		String path = MVCUtil.getPath(req);
		String filename = Cocit.me().getConfig().getClassDir() + path;
		if (!new File(filename).exists() && !Cocit.me().getConfig().isProductMode()) {
