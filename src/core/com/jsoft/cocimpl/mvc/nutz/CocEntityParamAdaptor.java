 ...
 * @author yongshan.ji
 */
public class CocEntityParamAdaptor extends AbstractAdaptor {
	...
	protected ParamInjector evalInjector(Class<?> type, Param param) {
		...
		// POJO with prefix
			...
			if (type.isAssignableFrom(CocEntityParam.class)) {
				return new CocEntityParamInjector(pm.substring(2));
			} else {
