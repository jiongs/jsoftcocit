package com.jsoft.cocimpl.util.compiler;

import java.io.File;

public class Main {

	private static String java_file_path = "E:/cocit/web/WEB-INF/tmp/BIZSRC/com/kmetop/Cocit/comlib/impl/sft/dynamic/system/";
