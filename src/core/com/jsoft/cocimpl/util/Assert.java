...
public abstract class Assert {
	...
	public static void doesNotContain(String textToSearch, String substring, String message) {
		if (!StringUtil.isBlank(textToSearch) && !StringUtil.isBlank(substring) && textToSearch.indexOf(substring) != -1) {
			throw new IllegalArgumentException(message);
		}
	}
	 ...
	 *            the object to check
	 * @param content
	 *            a content which will be prepended to the content produced by the function itself, and which may be used to provide context. It should normally end in a ": " or ". " so that the function generate content looks ok when prepended to
	 *            it.
	 * @throws IllegalArgumentException
	 *             if the object is not an instance of clazz
	 * @see Class#isInstance
	 ...
	 * 
	 * <pre class="code">
	 * Assert.state(id == null, &quot;The id properties must not already be initialized&quot;);
	 * </pre>
	 * 
	 * @param expression
	 *            a boolean expression
