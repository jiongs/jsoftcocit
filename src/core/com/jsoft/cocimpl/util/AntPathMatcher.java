...
public class AntPathMatcher implements PathMatcher {
	...
	protected boolean doMatch(String pattern, String path, boolean fullMatch) {
		...
		String[] pattDirs = StringUtil.toArray(pattern, this.pathSeparator);
		String[] pathDirs = StringUtil.toArray(path, this.pathSeparator);
	 ...
	 * @param str
	 *            string which must be matched against the pattern. Must not be <code>null</code>.
	...
	public String extractPathWithinPattern(String pattern, String path) {
		String[] patternParts = StringUtil.toArray(pattern, this.pathSeparator);
		String[] pathParts = StringUtil.toArray(path, this.pathSeparator);
